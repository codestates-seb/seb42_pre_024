...
public class AnswerController {
    public final static String ANSWER_DEFAULT_URL = "/questions";
...
//        answerDto.setQuestionId(questionId);
        ...
        Answer createAnswer = answerService.createAnswer(mapper.answerDtoToAnswer(answerDto/*, memberService/*, questionService*/), answerDto.getMemberId());
...
//        URI uri = UriMaker.getUri(ANSWER_DEFAULT_URL, createAnswer.getId());
    ...
    public ResponseEntity patchAnswer(@PathVariable("question-id") @Positive long questionId,
        ...
        Answer updateAnswer = answerService.updateAnswer(mapper.answerPatchDtoToAnswer(answerPatchDto), answerPatchDto.getMemberId());
